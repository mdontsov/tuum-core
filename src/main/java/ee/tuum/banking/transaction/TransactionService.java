...
import ee.tuum.banking.account.AccountMapper;
import ee.tuum.banking.account.BalanceMapper;
...
public class TransactionService {
    ...
    public TransactionService(AccountMapper accountMapper, BalanceMapper balanceMapper,
                              TransactionMapper transactionMapper, OutboxService outboxService,
                              Clock clock) {
